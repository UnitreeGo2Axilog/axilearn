...
export default function ProfilePage() {
  ...
  if (loading) {
    return <div className="mx-auto max-w-md px-4 py-12 text-strong0">…</div>;
  }
  ...
  return (
    <div className="mx-auto max-w-md px-4 py-12">
      <h1 className="mb-6 text-2xl font-bold text-strong">{t("profile.title")}</h1>
      <dl className="panel panel-glow space-y-3 rounded-2xl p-6 text-sm">
        <div className="flex justify-between">
          <dt className="text-muted">{t("auth.name")}</dt>
        ...
        <div className="flex justify-between">
          <dt className="text-muted">{t("profile.language")}</dt>
