...
const primerLevels = build([
  { id: "pp-1", title: "Introduction to Python", shortDescription: "What a program is, your first line of code, and why an error is not a punishment.", type: "lesson", state: "current", xpReward: 30, durationMinutes: 15, difficulty: "easy", skills: ["print", "comments"], section: "First steps", starterCode: "# Your turn. Change the message, then press Run.\nprint(\"Hello from my first program!\")\n" },
  { id: "pp-2", title: "Variables & Data Types", shortDescription: "Boxes with names: store text and numbers, and find out what type something is.", type: "lesson", state: "locked", xpReward: 30, durationMinutes: 15, difficulty: "easy", skills: ["variables", "types"], starterCode: "# Make a box, put something in it, show it.\nname = \"Axi\"\nlegs = 4\n\nprint(f\"{name} has {legs} legs.\")\n" },
  { id: "pp-3", title: "Conditions", shortDescription: "Teach your program to choose: if, else, and asking questions about numbers.", type: "lesson", state: "locked", xpReward: 40, durationMinutes: 20, difficulty: "easy", skills: ["if", "else", "comparison"], section: "Making decisions", starterCode: "# Change the distance and run it again.\ndistance = 15\n\nif distance < 20:\n    print(\"Too close -- stop!\")\nelse:\n    print(\"Clear ahead.\")\n" },
  { id: "pp-4", title: "Loops", shortDescription: "Do something ten times without typing it ten times.", type: "lesson", state: "locked", xpReward: 40, durationMinutes: 20, difficulty: "easy", skills: ["for", "while", "range"], starterCode: "# Count down, then blast off.\nfor n in range(5, 0, -1):\n    print(n)\n\nprint(\"Blastoff!\")\n" },
  { id: "pp-5", title: "Functions", shortDescription: "Give a block of code a name, and use it as many times as you like.", type: "lesson", state: "locked", xpReward: 50, durationMinutes: 20, difficulty: "easy", skills: ["def", "return", "arguments"], section: "Your own tools", starterCode: "# One recipe, used three times.\ndef greet(name):\n    return f\"Hello, {name}!\"\n\nprint(greet(\"Sara\"))\nprint(greet(\"Youssef\"))\nprint(greet(\"Axi\"))\n" },
  { id: "pp-6", title: "Strings", shortDescription: "Text is a thing you can measure, cut, join and shout.", type: "lesson", state: "locked", xpReward: 50, durationMinutes: 20, difficulty: "easy", skills: ["strings", "f-strings", "methods"], starterCode: "# Play with the text and run it again.\nword = \"robot\"\n\nprint(word.upper())\nprint(len(word))\nprint(word[0])\n" },
  { id: "pp-7", title: "Lists", shortDescription: "One box that holds many things, in order, and lets you count them.", type: "lesson", state: "locked", xpReward: 50, durationMinutes: 20, difficulty: "easy", skills: ["lists", "index", "append"], section: "Collections", starterCode: "# Add your own, then run it.\nparts = [\"leg\", \"motor\", \"sensor\"]\nparts.append(\"camera\")\n\nfor part in parts:\n    print(part)\n\nprint(f\"{len(parts)} parts in total.\")\n" },
  { id: "pp-8", title: "Dictionaries", shortDescription: "Look things up by name instead of by number, like a real dictionary.", type: "lesson", state: "locked", xpReward: 50, durationMinutes: 20, difficulty: "medium", skills: ["dict", "keys", "values"], starterCode: "# Look something up by its name.\nbattery = {\"level\": 82, \"charging\": False}\n\nprint(battery[\"level\"])\nbattery[\"level\"] = 41\nprint(battery)\n" },
  { id: "pp-9", title: "Mini Projects", shortDescription: "Put all nine chapters together and build three small programs that actually do something.", type: "final_project", state: "locked", xpReward: 90, durationMinutes: 30, difficulty: "medium", skills: ["everything"], badge: "Python Ready", section: "Build something", starterCode: "# Project 1 -- the robot check-up.\n# Fill in the blanks and run it.\n\nbattery = 45\ndistance = 12\n\nif battery < 20:\n    print(\"Go home and charge.\")\nelif distance < 20:\n    print(\"Something is in the way -- stop.\")\nelse:\n    print(\"All good, keep going.\")\n" },
]);
